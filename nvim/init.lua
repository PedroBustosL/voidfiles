...
if jit.os == 'Windows' then
  ...
  vim.api.nvim_create_user_command('Exec', 'set splitbelow | new | set ft=ps1 | read !pwsh.exe #', { desc = 'Execute current ps1 file' })

  vim.keymap.set("n", "<leader>t.", "<cmd>Exec<cr>", { desc = "Execute current ps1 file" })
end

if jit.os == 'Linux' then
  vim.api.nvim_create_user_command('Exec', 'set splitbelow | new | set ft=sh | read !sh #', { desc = 'Execute current bash file' })
...
-- New tab
vim.keymap.set('n', 'tn', ':tabnew<Return>')
...
require('lazy').setup {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>st', builtin.treesitter, {desc = '[S]earch Function names, variables, from [T]reesitter'})
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- vim.cmd.hi 'Normal guibg=0 ctermbg=0'
      -- vim.cmd.hi 'NormalNC guibg=0 ctermbg=0'
    end,
  },
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'c', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'javascript', 'typescript', 'vue', 'diff'},
